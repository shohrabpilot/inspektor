...
# Inspektor 🕵️‍♂️
![main status](https://github.com/shohrabpilot/inspektor/actions/workflows/publish.yaml/badge.svg?branch=main)
...
```kotlin
dependencies {
    implementation("pro.cashkeeper.inspektor:inspektor:latest-version")
}
```
